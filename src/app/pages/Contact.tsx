              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+33000000000" className="text-gray-700 hover:text-[#FF6B00] transition-colors">
                      [TÉLÉPHONE]
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@example.fr" className="text-gray-700 hover:text-[#FF6B00] transition-colors">
                      [EMAIL]
                    </a>
                  </div>
                </div>
