...
export const getServiceImage = (folderName: string): string => {
  ...
  const imageMap: Record<string, string> = {
    ...
    'entretien toiture': '/entretien toiture/entretien.jpg',
    'étanchéité liquide': '/etancheite-liquide/PHOTO-2026-02-05-16-34-51.jpg',
    'etancheite liquide': '/etancheite-liquide/PHOTO-2026-02-05-16-34-51.jpg',
